	...
	<div class="row">
		...
		<div class="container">
			...
			<table id="leave" class="table table-bordered">
				<thead>
					<tr>
					<th style="background-color: #008cff ;">Leave ID</th>
						<th style="background-color: #008cff;">Email</th>
						<th style="background-color: #008cff;">Leave Start</th>
						<th style="background-color: #008cff;">Leave End</th>
						<th style="background-color: #008cff;width: 18%;">Approval Status</th>
