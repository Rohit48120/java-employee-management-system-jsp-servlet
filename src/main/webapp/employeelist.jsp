	...
	<div class="row">
		...
		<div class="container">
			...
			<table  id="employee" class="table table-bordered">
				<thead>
					<tr>
						<th style="background-color: #FF7F50">Email</th>
						<th style="background-color: #FF7F50;width: 19%;">Name</th>
						<th style="background-color: #FF7F50">Password</th>
						<th style="background-color: #FF7F50;width: 17%;">Date Of Birth<br> YY-MM-DD</th>
						<th style="background-color: #FF7F50;width: 15%;">Department Id</th>
						<th style="background-color: #FF7F50;">A/C Status</th>
						<th style="background-color: #FF7F50;width: 20%;" >Update Activation Account</th>	
						<th style="background-color: #FF7F50;width: 30%;" >Update/Add Employee Department</th>
