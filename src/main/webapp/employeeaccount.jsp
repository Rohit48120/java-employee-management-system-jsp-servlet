...
<body>
  <h1 id="h">Employee Account Details</h1>
  <h2 >==================================</h2>
 <%
...
if(employee.getdeptName() == null || employee.getdeptName().isEmpty())
  out.println("<h2>"+"Your Department Name :"+"You didn't assigned to any department yet"+"</h2>");
else 
  out.println("<h2>"+"Your Department Name :"+employee.getdeptName()+"</h2>");
