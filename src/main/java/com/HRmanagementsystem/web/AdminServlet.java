...
@WebServlet({"/newDepartment","/addProject","/addManager","/addOrUodateEmployeedept","/reviewleaveapplication"
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 response.setContentType("text/html");   
		  try {
			...
			case "/addOrUodateEmployeedept":
				addOrUodateEmployeeDepartment(request, response);
				break;
...
private void addOrUpdateDepartmentProject(HttpServletRequest request,HttpServletResponse response) throws SQLException,ServletException, UnsupportedEncodingException, IOException{
		...
		String message=dao.addProjectToDepartment(projectNameString, deptId);
			response.getWriter().println("<html><body><b><script>alert(\"Updated the department project\")</script></b></body></html>");
		} catch (DepartmentException | IOException e) {
			 response.getWriter().println("<html><body><b><script>alert(\"An error occurred while upating department project\")</script></b></body></html>");
			e.printStackTrace();
		}
	}
...
private void addOrUpdateDepartmentManager(HttpServletRequest request,HttpServletResponse response) throws SQLException,ServletException, UnsupportedEncodingException, IOException{
		...
		String message=dao.assignManagerToDepartment(projectNameString.trim(), deptId);
			response.getWriter().println("<html><body><b><script>alert(\"Department manager created\")</script></b></body></html>");
		} catch (IOException | EmployeeException e) {
			 response.getWriter().println("<html><body><b><script>alert(\"Problem occurred while created manager\")</script></b></body></html>");
			e.printStackTrace();
		}
	}


private void addOrUodateEmployeeDepartment(HttpServletRequest request,HttpServletResponse response) throws SQLException,ServletException, UnsupportedEncodingException, IOException{
	...
	String message=dao.assignEmployeeToDepartment(projectNameString.trim(), deptId);
		response.getWriter().println("<html><body><b><script>alert(\"Employee department created successfully\")</script></b></body></html>");
	} catch (IOException | EmployeeException | DepartmentException e) {
		 response.getWriter().println("<html><body><b><script>alert(\"An error occurred while creating department\")</script></b></body></html>");
		e.printStackTrace();
	}
}
...
private void approveEmployeeLeave(HttpServletRequest request,HttpServletResponse response) throws SQLException,ServletException, UnsupportedEncodingException, IOException{
	...
	//System.out.println(message);
		response.getWriter().println("<html><body><b><script>alert(\"Employee leave approved successfully\")</script></b></body></html>");
	} catch ( IllegalStateException | IOException  | DepartmentException e) {
		 response.getWriter().println("<html><body><b><script>alert(\"Cannot approve employee leave...Try again\")</script></b></body></html>");
		e.printStackTrace();
	}
}
...
private void activateOrDeactivateEmployeeAccount(HttpServletRequest request,HttpServletResponse response) throws SQLException,ServletException, UnsupportedEncodingException, IOException{
	...
	String message=dao.verifyEmpAccount(username.trim(), Id);
        response.getWriter().println("<html><body><b><script>alert(\"Employee account state changed successfully\")</script></b></body></html>");
		
	} catch ( IllegalStateException | IOException   | EmployeeException e) {
		
		 response.getWriter().println("<html><body><b><script>alert(\"An error occurred while activating or deactivating employee account\")</script></b></body></html>");
		e.printStackTrace();
	}
}
...
private void deleteLeaveRequest(HttpServletRequest request,HttpServletResponse response) throws SQLException, UnsupportedEncodingException, IOException {
	  ...
	  int leaveid=Integer.parseInt(request.getParameter("leaveid").trim());
	   ...
	   response.getWriter().println("<html><body><b><script>alert(\"Employee leave request has been deleted\")</script></b></body></html>");
}
...
private void deleteEmployee(HttpServletRequest request,HttpServletResponse response)  {
	     ...
	     try {
			...
			response.getWriter().println("<html><body><b><script>alert(\"Employee deleted successfully\")</script></b></body></html>");
...
private void deletestatus(HttpServletRequest request,HttpServletResponse response) throws UnsupportedEncodingException, IOException  {
	...
	String message=dao.deleteOldStatus(id);
	 ...
	 response.getWriter().println("<html><body><b><script>alert(\"Status deleted successfully\")</script></b></body></html>");
